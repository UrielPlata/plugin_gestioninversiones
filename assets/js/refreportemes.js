...
$(document).ready( function() {
  ...
  =============================================*/
    ...
    $(".tab-referralreportemes").DataTable({
      pageLength : 25,
  ...
  $("#refrep-fecha").on('submit', buscarmes );
  ...
  if(messel >= meshoy){
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        let tabla = $(".tab-referralreportemes").DataTable();
        ...
        if(datos === null){
          ...
          let totalutlreal = resultado.data.totalutlreal;
          // console.log();

          $(".totalutlreal").html(totalutlreal);
