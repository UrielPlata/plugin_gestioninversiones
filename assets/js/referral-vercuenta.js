...
( function( $ ) {
  ...
  $('#form-addregnbl').on('submit', agregarRegistroBl );
  $('#form-editregnbl').on('submit', editarRegistroBl );
  ...
  $('.tab-referralcuentan').on('click','.btn-editar', function(e){
  ...
  $('.tab-referralcuentan').on('click','.btn-eliminar', function(e){
      ...
      var resultado1 = JSON.parse(data);
        ...
        if(resultado1.data.length != 0){
          ...
          $.ajax({
              type:'post',
              data: {
                'action' : 'referral_agregarregistro',
                'cid' : cid,
                'mes' : mes,
                'year' : year,
                'utilmes' : utilmes,
          ...
          if(resultado.respuesta==1){
              ...
              setTimeout(function(){
                let protocol = window.location.protocol;
            		let url = "admin.php?page=crc_referral_dashboard";
