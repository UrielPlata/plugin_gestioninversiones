...
( function( $ ) {
  ...
  $('#form-agreditdep').on('submit', editarDepositoAgr );
  $('#form-agrfindep').on('submit', finalizarDepositoAgr );
  $('#form-agrcancdep').on('submit', cancelarDepositoAgr );

  $('.tab-agreadmindepositos').on('click','.btn-editar', function(e){
  ...
  $('.tab-agreadmindepositos').on('click','.btn-finalizar', function(e){
  ...
  $('.tab-agreadmindepositos').on('click','.btn-cancelar', function(e){
...
$('.tab-agreadmindepositos').on('mouseenter','.microtexto', function(e){
...
function finalizarDepositoAgr(e){
...
function cancelarDepositoAgr(e){
