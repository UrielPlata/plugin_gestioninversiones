...
( function( $ ) {
  ...
  $('.tab-referralusers').on('click','.btn-editar', function(e){
  ...
  $('.tab-referralusers').on('click','.btn-addcuenta', function(e){
  ...
  $('.tab-referralusers').on('click','.btn-verreporte', function(e){
  ...
  $('.tab-referralusers').on('click','.btn-verreportespe', function(e){
  ...
  $('.tab-referralusers').on('click','.btn-eliminar', function(e){
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if(resultado.respuesta==1){
              $(".tab-referralusers").DataTable().ajax.reload();
  ...
  $('.tab-referralusers').on('mouseenter','.microtexto', function(e){
