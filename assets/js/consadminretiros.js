...
( function( $ ) {
  ...
  $('#form-coneditret').on('submit', editarRetiroCon );
  $('#form-confinret').on('submit', finalizarRetiroCon );
  $('#form-concancret').on('submit', cancelarRetiroCon );

  $('.tab-consadminretiros').on('click','.btn-editar', function(e){
  ...
  $('.tab-consadminretiros').on('click','.btn-finalizar', function(e){
  ...
  $('.tab-consadminretiros').on('click','.btn-cancelar', function(e){
...
$('.tab-consadminretiros').on('mouseenter','.microtexto', function(e){
      ...
      if(result.value){
          ...
          success: function(data) {
            ...
            if(resultado.respuesta==1){
              $("#modal-coneditret").modal('toggle');
              $("#ecantidadfin").val('0.00');
              $("#eidmovind").val('');
              $('#enotas').val('');
              $(".tab-consadminretiros").DataTable().ajax.reload();
                swal(
                'Retiro editado',
