...
( function( $ ) {
  ...
  $('#form-agreditretmas').on('submit', editarRetiroMasAgr );
  $('#form-agrfinretmas').on('submit', finalizarRetiroMasAgr );
  $('#form-agrcancretmas').on('submit', cancelarRetiroMasAgr );

  $('.tab-agreretmaster').on('click','.btn-editar', function(e){
  ...
  $('.tab-agreretmaster').on('click','.btn-finalizar', function(e){
  ...
  $('.tab-agreretmaster').on('click','.btn-cancelar', function(e){
...
$('.tab-agreretmaster').on('mouseenter','.microtexto', function(e){
...
function finalizarRetiroMasAgr(e){
    ...
    swal({
      ...
      if(result.value){
          ...
          success: function(data) {
            ...
            console.log(resultado);
            if(resultado.respuesta==1){
              $("#modal-agrfinretmas").modal('toggle');
              $("#cantidadfin").val('0.00');
              $("#idmovind").val('');
              $("#fechafin").val('');
              $("#fechasol").val('');
              $(".tab-agreretmaster").DataTable().ajax.reload();
                swal(
                'Retiro autorizado',
                'El administrador vera ahora su retiro como autorizado dentro de su historial.',
                'success'
              )
            }else{
              swal(
...
function cancelarRetiroMasAgr(e){
